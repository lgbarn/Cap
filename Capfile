...
role :hadoop_nn, "root@10.15.22.11", "root@10.15.22.12", "root@10.15.22.13", "root@10.15.22.14", "root@10.15.22.34", "root@10.15.22.35"
role :hadoop_data, "root@10.15.22.15", "root@10.15.22.16", "root@10.15.22.17", "root@10.15.22.18", "root@10.15.22.19", "root@10.15.22.20", "root@10.15.22.21", "root@10.15.22.22", "root@10.15.22.23", "root@10.15.22.24", "root@10.15.22.25", "root@10.15.22.26", "root@10.15.22.27", "root@10.15.22.28", "root@10.15.22.29", "root@10.15.22.31", "root@10.15.22.32", "root@10.15.22.36", "root@10.15.22.37", "root@10.15.22.38", "root@10.15.22.39", "root@10.15.22.40", "root@10.15.22.41" 
...
desc "Disable Swap"
task :disable_swap, :roles => :hadoop_nn do
#  run "swapoff -a"
  run "sed '/swap/s/^/#/g' -i /etc/fstab"
end
desc "Check Swap"
task :check_swap, :roles => :hadoop_all do
#  run "sed '/swap/s/^/#/g' -i /etc/fstab"
  run "grep swap /etc/fstab"
#  run "cat /proc/swaps"
end
desc "Reboot Data"
task :reboot_data, :roles => :hadoop_data do
  run "reboot"
end
